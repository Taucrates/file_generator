...
void poseACallback(const nav_msgs::Odometry::ConstPtr& pose)
{
  ...
  actual_pose_a.time = sec + (nsec / 1000000000);
...
void poseBCallback(const nav_msgs::Odometry::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_pose_b.time = sec + (nsec / 1000000000);
...
void poseCCallback(const nav_msgs::Odometry::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_pose_c.time = sec + (nsec / 1000000000);
...
void poseDCallback(const nav_msgs::Odometry::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_pose_d.time = sec + (nsec / 1000000000);
...
void poseECallback(const nav_msgs::Odometry::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_pose_e.time = sec + (nsec / 1000000000);
...
void amclACallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_amcl_a.time = sec + (nsec / 1000000000);
...
void amclBCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_amcl_b.time = sec + (nsec / 1000000000);
...
void amclCCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_amcl_c.time = sec + (nsec / 1000000000);
...
void amclDCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_amcl_d.time = sec + (nsec / 1000000000);
...
void amclECallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr& pose)
{
  ...
  double sec = pose->header.stamp.sec;
  double nsec = pose->header.stamp.nsec;
  actual_amcl_e.time = sec + (nsec / 1000000000);
...
int main(int argc, char **argv)
{
  ...
  /*ros::Subscriber pose_a_sub = n.subscribe("/kobuki_a/amcl_pose", 1000, amclACallback);
  ros::Subscriber pose_b_sub = n.subscribe("/kobuki_b/amcl_pose", 1000, amclBCallback);
  ros::Subscriber pose_c_sub = n.subscribe("/kobuki_c/amcl_pose", 1000, amclCCallback);
  ros::Subscriber pose_d_sub = n.subscribe("/kobuki_d/amcl_pose", 1000, amclDCallback);
  ros::Subscriber pose_e_sub = n.subscribe("/kobuki_e/amcl_pose", 1000, amclECallback);*/
